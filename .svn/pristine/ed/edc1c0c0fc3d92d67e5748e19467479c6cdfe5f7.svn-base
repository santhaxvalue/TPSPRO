...
public class MontserratTextViewPlus extends TextViewPlus {

    static Typeface fontnormal;
    Context mContext;

    public MontserratTextViewPlus(Context context, AttributeSet attrs,
                                  int defStyle) {
    ...
    public MontserratTextViewPlus(Context context) {
        super(context);
        init(context, null);
    }

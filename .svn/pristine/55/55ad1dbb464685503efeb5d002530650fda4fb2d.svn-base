...
public class AlertPrivacyPolicyFragment extends BaseFragment implements OnClickListener {
    ProgressDialog pd;
    private WebView browser;
    private LinearLayout ll_error;
    private String failUrl;

    public static AlertPrivacyPolicyFragment newInstance() {
        return new AlertPrivacyPolicyFragment();
    }
    ...
    public void open() {
        String url = InformatePreferences.getStringPrefrence(getActivity(), Constants.PREF_PRIVACYPOLICY);// "https://www.thepanelstation.com/";
    ...
    private void pogressDialog() {
        pd = new ProgressDialog(getActivity());// Assuming that you are using
        // fragments.
        // pd.setTitle(getString(R.string.dialog_login));
    ...
    private class MyBrowser extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            } else if (url.startsWith("mailto:") || url.startsWith("mailto")) {
                // Utility.shareEmailUs(getActivity(),

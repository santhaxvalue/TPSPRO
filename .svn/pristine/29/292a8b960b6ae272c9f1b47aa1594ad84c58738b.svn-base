...
import com.panelManagement.asyncimage.ImageRequest.ImageRequestCallback;
...
public class AsyncImageView extends ImageView implements ImageRequestCallback {
    ...
    public AsyncImageView(Context context, AttributeSet attrs) {
        ...
        newsApp = (TPSApplication) context.getApplicationContext();
    }
    ...
    public void reload(boolean force) {
        if (mRequest == null && mUrl != null) {
            mBitmap = null;
            if (!force) {
                mBitmap = newsApp.getImageCache().get(mUrl, mOptions);
            }
    ...
    public void setUrl(String url) {
        ...
        if (mOptions == null) {
            mOptions = ImageOptions.getProductPicImageOptions(getContext());
        }
        stopLoading();
        mUrl = url;
    ...
    public static interface OnImageViewLoadListener {
        ...
        /**
         * Called when the image_layout ended to load that is when the image_layout has been

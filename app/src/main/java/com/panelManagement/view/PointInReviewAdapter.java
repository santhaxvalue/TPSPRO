...
//            holder.surveyEarn.setText("Points/Ticket No: "+strreviewPointsList+ " Points");
            holder.surveyEarn.setText(context.getResources().getString(R.string.points_and_ticketno) +strreviewPointsList+ context.getResources().getString( R.string.points_new));
        }

            if(!strsurveyIdList.equalsIgnoreCase("") && strsurveyIdList!=null){
//                holder.tv_serveyID.setText("SURVEY ID : "+strsurveyIdList);
                holder.tv_serveyID.setText(context.getResources().getString(R.string.survey_id_new) +strsurveyIdList);
            }
